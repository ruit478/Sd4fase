...
int testResult() {
  ...
  result = result && msg->opcode == OC_PUT && msg->c_type == CT_RESULT &&
           msg->table_num == 7 && msg->content.result == 1;
...
int testKey() {
  ...
  result = result && msg->opcode == OC_PUT && msg->c_type == CT_KEY &&
           msg->table_num == 8 && strcmp(msg->content.key, "abcdef") == 0;
...
int testValue() {
  ...
  result = result && msg->opcode == OC_PUT && msg->c_type == CT_VALUE &&
           msg->table_num == 9 &&
...
int testEntry() {
  ...
  result = result && msg->opcode == OC_PUT && msg->c_type == CT_ENTRY &&
           msg->table_num == 10 &&
...
int testKeys() {
  ...
  result = result && msg->opcode == OC_PUT && msg->c_type == CT_KEYS &&
           msg->table_num == 12 && strcmp(msg->content.keys[0], keys[0]) == 0 &&
